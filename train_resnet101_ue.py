...
def main():
    root = 'xx/Datasetforpt/dataset_origin/2_Potato Leaf Disease Dataset in Uncontrolled Environment'
    splits_dir = 'xx/Datasetforpt/dataset_origin/duzixunlian/splits_ue'
    ...
    ckpt_path = os.path.join(ckpt_dir, 'resnet101_ue_best.pth')
