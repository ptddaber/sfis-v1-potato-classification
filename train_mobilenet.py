#!/usr/bin/env python3
"""
MobileNet V2 & V3 Training Script
Supports: mobilenet_v2, mobilenet_v3_small, mobilenet_v3_large
Usage: python train_mobilenet.py --model mobilenet_v3_large --dataset pld
"""
import os
import sys
import random
...
def main():
    ...
    # Create model
    model = MOBILENET_MODELS[args.model](pretrained=True)
    # The classifier head for MobileNet varies by version
